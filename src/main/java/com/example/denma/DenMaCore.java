...
public class DenMaCore {
    ...
    public static String[] getAdminData() {
        ...
        {
            System.out.println("Le fichier configuration système n'éxiste pas.");
        }
        return lizt;
    }
    ...
    public static void createCoreDir() {
        File pathFile = new File("C:\\DenMa");
...
/////////////////////////////////////////////////////////////////////////
    ...
    public static int nbrePatients() {
        ...
        {
            System.out.println("Les données d'auto incrémentation n'éxistent pas");
        }
        return nbre;
    }
